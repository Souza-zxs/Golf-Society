...
export function BlogPostCard({ post }: { post: BlogPost }) {
  return (
    <Link href={`/blog/${post.slug}`} className="group flex flex-col gap-4">
      <div className="aspect-[4/3] overflow-hidden border border-ink/10 bg-ivory-2">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <h3 className="font-display text-xl leading-snug text-ink transition-colors group-hover:text-gold">
          {post.title}
        </h3>
